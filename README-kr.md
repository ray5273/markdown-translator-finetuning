...
다양한 오픈 웨이트(Open Weight) LLM을 파인튜닝하여 한국어 마크다운 문서를 영어로 번역하는 프로젝트입니다.

EXAONE, Llama, Qwen, Gemma 등 다양한 오픈소스 모델을 지원합니다.

[English README](./README.md)

## Features

- **다양한 모델 지원**: EXAONE 3.5, Llama 3.1, Qwen 2.5, Gemma 2 등 다양한 오픈 웨이트 LLM 지원
- **마크다운 구조 보존**: 코드 블록, 링크, 테이블 등 마크다운 요소를 보존하며 번역
- **QLoRA 지원**: 4-bit 양자화로 RTX 3090/4080에서도 학습 가능
- **유연한 데이터 생성**: 템플릿, OpenAI, Anthropic, Ollama, vLLM 등 다양한 방법으로 학습 데이터 생성
...
# 기본 모델 로드 (사용할 모델에 맞게 변경)
# 예시: EXAONE, Llama, Qwen 등
...
|-------|----------|--------------|------|
| EXAONE 3.5 | `LGAI-EXAONE/EXAONE-3.5-7.8B-Instruct` | 12GB | 한국어 특화 |
| Llama 3.1 | `meta-llama/Llama-3.1-8B-Instruct` | 10GB | 범용 |
| Qwen 2.5 | `Qwen/Qwen2.5-7B-Instruct` | 10GB | 다국어 지원 |
| Gemma 2 | `google/gemma-2-9b-it` | 12GB | 균형잡힌 성능 |
